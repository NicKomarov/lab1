...
namespace LibraryWebApp.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(DblibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Languages != null ? 
                          ...
                          Problem("Entity set 'DblibraryContext.Languages'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Books", new { sortId = "language", id = language.Id, name = language.Name });
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DblibraryContext.Languages'  is null.");
            }
            var language = await _context.Languages.FindAsync(id);
            if (language != null)
            {
